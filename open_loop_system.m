...
figure(1);
bode(P_s);
plot_response(2, 'Pulse', 'Steer Angle', 'Heading Angle', P_s, in_pulse, t);
plot_response(3, 'Step', 'Steer Angle', 'Heading Angle',  P_s, in_step, t);
plot_response(4, 'sin 1 rad/s', 'Steer Angle', 'Heading Angle',  P_s, in_sin_1, t);
plot_response(5, 'sin 2 rad/s', 'Steer Angle', 'Heading Angle',  P_s, in_sin_2, t);
plot_response(6, 'Sin 5 rad/s', 'Steer Angle', 'Heading Angle',  P_s, in_sin_5, t);
